# Generated by Django 5.0.1 on 2024-03-28 13:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='division', to='workshops.division')),
            ],
        ),
        migrations.CreateModel(
            name='Workshop',
            fields=[
                ...
                ('workshop_colocated', models.CharField(blank=True, max_length=20)),
                ('number_splits_volume', models.IntegerField()),
                ('volume_number', models.IntegerField(blank=True, null=True)),
                ('number_submitted_papers', models.IntegerField()),
                ('number_accepted_papers', models.IntegerField()),
                ('number_regular_size_papers', models.IntegerField()),
                ('number_short_size_papers', models.IntegerField()),
                ('secret_token', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ...
                ('sessions', models.ManyToManyField(blank=True, related_name='workshops_sessions', to='workshops.session')),
            ],
        ),
        migrations.AddField(
            model_name='paper',
